...
class Cliente{
    ...
    public function __construct($customer_id,$customer_name,$customer_email, $customer_contact,$customer_address,$country){
    ...
    public function guardarCliente(){
        ...
        global $bd;
        $sql = "INSERT INTO customers (customer_id,customer_name,customer_email,customer_contact,customer_address,country) 
        VALUES ('$this->customer_id','$this->customer_name','$this->customer_email',
        '$this->customer_contact','$this->customer_address','$this->country')";
