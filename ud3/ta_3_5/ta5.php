<?php  
//llamar al fichero en el que se crearon las clases.
          ...
          <?php
            ...
            <form action="<?=$_SERVER['PHP_SELF'];?>" methog="GET">
              <tr>
                  ...
                  <td> <a href="equipo.php?nombreequipo=<?php echo $equipo['Nombre'];?>&idequipo=<?php echo $equipo['IDEquipo'];?>"><?php echo $equipo['Nombre']; ?></a></td>
                  ...
                  <input type="hidden" name="nombreequipo" value="<?php echo $equipo['Nombre']; ?>">
              </tr>
            </form>
            <?php
              }
